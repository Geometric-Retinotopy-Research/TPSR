...
%% Syntax
% [Fout, Vout, new2OldMap] = gf_remove_mesh_vertices(F, V, id2delete)
...
function [Fout, Vout, new2OldMap] = gf_remove_mesh_vertices(F, V, id2delete)
...
% bd = compute_bd(Fout);
% Fout(ismember(Fout(:,1),bd) & ismember(Fout(:,2),bd) &ismember(Fout(:,3),bd),:)=[];
%  
