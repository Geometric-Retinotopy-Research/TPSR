...
%
% Parameter(s):
%		face[double array] -- faces of himesphere
%       uv_pod[double array] -- including the parameters about r and theta
%       from polar coordinate
%       vis[double array] -- Correct the visual coordinates
%       R2[double array] -- extra value, like prf value 
%       bd_id[double array] -- boundary array
%       bd_vis0[double array] -- boundary cooardinate visual system  
%       changetol[double] -- 
%       smooth_lambda0[double] -- initial of smooth
%       smooth_avg_k -- size of smooth along the boundary
%       meanddth[double] -- average ddth 
% return:
%       hat_vis[double array] -- result of smooth
%		flip[int] -- the number of flips
%       smooth_lambda[double] -- result of lambda after smooth
%
%%
