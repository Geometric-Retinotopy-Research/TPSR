...
visxy_s = laplacian_smooth(uv_p,visxy_corrected);

[meanse, std_vd, mean_ang, std_ang, flip]=evaulate_metric(visxy_s,visxy_corrected,Froi,uv_p);
fprintf('Laplacian smoothing meanse = %f, std_vd = %f, meanang = %f, maxang = %f flip =%d\n', meanse, std_vd, mean_ang, std_ang, flip);
 
vis_c = restore_vis(visxy_s);showfigure(Froi, vis_c, anchor)   
showresulton_inflatedmesh(Froi,Em.Vertex_Vinflate(vfather,:), uv_roi, vis_c, Ffull, Efull);
...
rendercolor = rendercolor*0.5 + [189 140 124 ]/255*0.5;
...
camva(8.371876);
set(gca,'CameraPosition',[123.285857 -197.732562 -133.122630])
set(gca,'Position',[0.330000 -0.090000 0.775000 0.815000])
set(gca,'Xlim',[-47.346337 -31.656404])
set(gca,'Ylim',[-82.455936 -43.028756])
set(gca,'Zlim',[-6.471905 21.438808])
set(gcf,'position',[100.000000 100.000000 400.000000 500.000000])
